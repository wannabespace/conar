...
export function ClickHouseIcon({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg height="2500" viewBox="27 24.5 100.1 100.1" width="2417" xmlns="http://www.w3.org/2000/svg" className={cn('text-foreground', className)} {...props}>
      <path
