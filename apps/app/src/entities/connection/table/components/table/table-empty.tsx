...
export function TableEmpty({ className, title, description }: { className?: string; title: string; description: string }) {
  return (
    <div className={cn(`pointer-events-none sticky left-0 flex items-center justify-center`, className)}>
      <div className="flex h-32 w-full flex-col items-center justify-center">
        <div className="mb-4 flex items-center justify-center rounded-full bg-muted/60 p-3">
