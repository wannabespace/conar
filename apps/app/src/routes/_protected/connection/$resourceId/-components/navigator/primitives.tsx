...
export const SidebarMenuButton = ({
  ...
  useRender({
    ...
    props: mergeProps<'button'>(
      {
        className: cn(
          `peer/menu-button hover:bg-accent hover:text-accent-foreground focus-visible:focus-ring active:bg-accent active:text-accent-foreground data-active:bg-accent data-active:text-accent-foreground flex h-8 w-full items-center gap-2 overflow-hidden rounded-xl px-3 py-2 text-left text-sm whitespace-nowrap outline-hidden disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate`,
          className
        ),
      },
      props
