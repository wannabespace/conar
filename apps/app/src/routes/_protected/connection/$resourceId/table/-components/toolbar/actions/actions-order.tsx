        ...
        {orderEntries.length === 0 ? (
          ...
          <div className="flex flex-col gap-0.5">
            {orderEntries.map(([columnId, order], index) => (
              <div
                key={columnId}
                className="group hover:bg-accent/50 flex h-7 items-center gap-2 rounded-md px-2"
              >
              ...
              <PopoverTrigger
                render={
                  <button
                    ...
                    className="text-muted-foreground hover:bg-accent/50 hover:text-foreground focus-visible:bg-accent flex h-7 w-full cursor-default items-center gap-2 rounded-md px-2 text-sm outline-none"
                  />
                }
              >
