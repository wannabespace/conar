...
const { useParams, useRouteContext, useSearch } = getRouteApi(
...
export const ChatForm = () => {
  ...
  const { resourceId, tabId } = useParams()
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="bg-input/32 relative flex flex-col gap-2 overflow-hidden rounded-md border">
        {!subscription && (
          ...
          <div className="pointer-events-auto flex gap-2">
            <Tooltip>
              <TooltipTrigger
                render={
                  <Button
                    ...
                    variant="outline"
                    className={
                      input.length < 10 ? 'cursor-default opacity-50' : ''
                    }
                    disabled={
                      status === 'submitted' ||
                      status === 'streaming' ||
              ...
              >
                ...
                >
                  <ContentSwitch
                    ...
                    activeContent={
                      <RiCheckLine className="text-success size-3" />
                    }
                  >
              ...
              <TooltipContent side="top">
                {input.length < 10
                  ? 'Prompt is too short to enhance'
                  : 'Enhance prompt'}
              </TooltipContent>
            </Tooltip>
