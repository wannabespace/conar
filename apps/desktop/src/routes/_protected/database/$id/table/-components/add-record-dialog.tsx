        ...
        return (
          <div className="flex w-full items-center space-x-2">
            <Input
              ...
              value={String(value)}
              disabled
              className="border-dashed bg-muted/30 text-muted-foreground italic"
          ...
          {columns.map(column => (
            ...
            >
              <Label
                ...
                className="col-span-3 truncate pr-2 text-right text-sm"
                title={column.id}
              >
                {column.id}
                {!column.isNullable && <span className="ml-0.5 text-red-500">*</span>}
              </Label>
