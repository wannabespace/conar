          ...
          filters: z
            .object({
              ...
              operator: z
                ...
                .describe(
                  'The operator to use for the filter, must be one of the available SQL operators'
                ),
              values: z
                .array(
                  z.string().describe('A value to filter by for the specified column and operator')
                )
                .describe('The values to filter by for the given column and operator'),
            })
            .array()
            .describe(
              'An array of filter objects, each specifying a column, operator, and values to filter by'
            ),
        })
