...
function FeatureCard({ className, children, featureId, ...props }: FeatureCardProps) {
  return (
    <article
      className={cn('bg-card border p-8 rounded-2xl hover:shadow-lg transition-all duration-300 hover:border-border/60', className)}
...
function FilterItem({ name, operator, value, onRemove }: FilterItemProps) {
  return (
    <div className="flex items-center border rounded-md overflow-hidden h-7 bg-input/40 hover:bg-input/60 transition-colors">
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <FeatureCardTitle
        ...
        title="AI-Powered Data Filtering"
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <FeatureCardTitle
        ...
        description="Ask questions in natural language and get instant SQL queries generated by AI."
...
function CloudSync() {
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      />
      <div className="space-y-3 sm:space-y-4">
        <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-muted/30 to-muted/50 rounded-xl border border-border/50 hover:border-border hover:shadow-md transition-all duration-300">
...
function DataActionCard({ icon, title, description, color }: DataActionCardProps) {
  ...
  return (
    <div className={`p-3 sm:p-4 bg-gradient-to-br ${colorClasses[color]} rounded-lg border hover:shadow-md transition-all duration-300 cursor-pointer`}>
      <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
        <div className={`size-6 sm:size-7 ${bgColorClasses[color]} rounded-md flex items-center justify-center flex-shrink-0`}>
          <div className={iconColorClasses[color]} aria-hidden="true">
            {icon}
          </div>
        </div>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <DataActionCard
            ...
            title="Delete"
            description="Remove records with confirmation and rollback options"
            color="red"
          />
        </div>
      </div>
