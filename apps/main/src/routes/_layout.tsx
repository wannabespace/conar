...
function MainLayout() {
  ...
  return (
    <motion.div className="relative isolate container mx-auto flex min-h-svh flex-col px-4" style={{ '--navbar-height': navbarHeightPx }}>
      <div className={cn(`sticky top-0 z-50 h-(--navbar-height) w-full bg-gray-100 dark:bg-neutral-950`)}>
      ...
      <div className="rounded-3xl bg-background">
        ...
        >
          <BlurGradient className={`absolute inset-x-0 h-48 transition-all delay-300 duration-400`} />
        </motion.div>
        <Outlet />
