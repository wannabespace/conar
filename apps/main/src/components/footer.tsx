  ...
  return (
    <footer className={`container mx-auto flex flex-col items-center justify-between gap-4 p-4 sm:flex-row sm:gap-0 sm:px-0`}>
      ...
      <div className={`flex flex-1 items-center justify-center gap-2 sm:justify-end`}>
        <a href={SOCIAL_LINKS.TWITTER} target="_blank" rel="noopener noreferrer" className={`text-muted-foreground transition-colors hover:text-foreground`}>
          <RiTwitterXLine className="size-4" />
        </a>
        <a href={SOCIAL_LINKS.DISCORD} target="_blank" rel="noopener noreferrer" className={`text-muted-foreground transition-colors hover:text-foreground`}>
          <RiDiscordLine className="size-4" />
        </a>
        <a href={SOCIAL_LINKS.GITHUB} target="_blank" rel="noopener noreferrer" className={`text-muted-foreground transition-colors hover:text-foreground`}>
