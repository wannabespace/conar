...
const inputGroupAddonVariants = cva(
  `
    flex h-auto cursor-text items-center justify-center gap-2 leading-none
    select-none
    [&_svg]:-mx-0.5
    ...
    <div
      className={cn(
        `
          ...
          border-input bg-background text-base text-foreground shadow-xs/5
...
export function InputGroupText({
  ...
  return (
    <span
      className={cn(
        `
          line-clamp-1 flex items-center gap-2 leading-none whitespace-nowrap
