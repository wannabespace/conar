...
export const SingleAccordionTrigger = ({
  children,
  className,
  asChild,
  render,
...
export const SingleAccordionTriggerArrow = ({
  className,
}: {
  className?: string
}) => (
...
export const SingleAccordionContent = ({
  children,
  className,
  ...props
...
>) => (
  <AccordionPrimitive.Root
    className={cn(
      'bg-card text-card-foreground w-full rounded-lg border',
      className
    )}
    value={(() => {
      if (open) {
