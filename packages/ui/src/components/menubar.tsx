...
const MenubarItem = ({
  ...
  <DropdownMenuItem
    ...
    className={cn(
      `group/menubar-item focus:bg-accent focus:text-accent-foreground focus:not-data-[variant=destructive]:**:text-accent-foreground data-[variant=destructive]:text-destructive focus:data-[variant=destructive]:bg-destructive/15 focus:data-[variant=destructive]:text-destructive *:[svg]:text-foreground/70 data-[variant=destructive]:*:[svg]:text-destructive! min-h-7 gap-2 rounded-lg px-2 py-1.5 text-sm font-[450] tracking-wide data-disabled:opacity-50 data-inset:pl-7 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  />
...
const MenubarCheckboxItem = ({
  ...
  <MenuPrimitive.CheckboxItem
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground relative flex min-h-7 cursor-default items-center gap-2 rounded-lg py-1.5 pr-1.5 pl-7 text-sm font-[450] tracking-wide outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0`,
      className
    )}
    checked={checked}
    {...props}
...
const MenubarRadioItem = ({
  ...
  <MenuPrimitive.RadioItem
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground *:[svg]:text-foreground/70 relative flex min-h-7 cursor-default items-center gap-2 rounded-lg py-1.5 pr-1.5 pl-7 text-sm font-[450] tracking-wide outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  >
