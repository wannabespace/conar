...
export const buttonVariants = cva(
  `relative inline-flex shrink-0 items-center justify-center gap-2 rounded-lg border text-base font-medium whitespace-nowrap transition-shadow outline-none before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 sm:text-sm pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4`,
  {
    defaultVariants: {
      size: 'default',
      variant: 'default',
    ...
    variants: {
      size: {
        ...
        'icon-2xs': `size-6 rounded-sm before:rounded-[calc(var(--radius-sm)-1px)] sm:size-5 not-in-data-[slot=input-group]:[&_svg:not([class*='size-'])]:size-3 sm:not-in-data-[slot=input-group]:[&_svg:not([class*='size-'])]:size-2.5`,
      ...
      variant: {
        ...
        'warning': `border-warning bg-warning text-white shadow-xs shadow-warning/24 not-disabled:inset-shadow-[0_1px_--theme(--color-white/16%)] hover:bg-warning/90 data-pressed:bg-warning/90 *:data-[slot=button-loading-indicator]:text-white`,
