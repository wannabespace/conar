    ...
    <div
      ...
      className={cn(
        `
          ...
          text-sm text-card-foreground shadow-sm ring-1 ring-foreground/5
          ...
          *:[img:last-child]:rounded-b-[min(var(--radius-4xl),24px)]
        `,
        className,
      )}
      {...props}
    ...
    <div
      ...
      className={cn(
        `
          ...
          items-start gap-1.5 rounded-t-[min(var(--radius-4xl),24px)]
          px-(--card-spacing)
...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          flex items-center rounded-b-[min(var(--radius-4xl),24px)]
          px-(--card-spacing)
