    ...
    >
      ...
      >
        <SliderPrimitive.Track
          ...
          className="
            relative grow overflow-hidden rounded-2xl bg-input/90 select-none
        ...
        {Array.from({ length: values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            key={index}
            className="
              block size-4 shrink-0 rounded-2xl bg-white bg-clip-padding shadow-md
              ring-1 ring-black/10 transition-[color,box-shadow]
              duration-200
              select-none
