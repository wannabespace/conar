  ...
  `,
  {
    ...
    variants: {
      size: {
        default:
          `
            h-5.5 min-w-5.5 px-[calc(--spacing(1)-var(--border-hairline))]
            text-sm
            sm:h-4.5 sm:min-w-4.5 sm:text-xs
          `,
        lg: `
          h-6.5 min-w-6.5 px-[calc(--spacing(1.5)-var(--border-hairline))]
          text-base
          sm:h-5.5 sm:min-w-5.5 sm:text-sm
        `,
        sm: `
          h-5 min-w-5 rounded-[.25rem]
          px-[calc(--spacing(1)-var(--border-hairline))] text-xs
          sm:h-4 sm:min-w-4 sm:text-[.625rem]
        `,
      },
      variant: {
        default:
