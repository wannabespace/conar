...
const ToggleGroupItem = ({
  ...
  return (
    <TogglePrimitive
      ...
      className={cn(
        `data-[state=on]:bg-muted shrink-0 group-data-[spacing=0]/toggle-group:rounded-none group-data-[spacing=0]/toggle-group:px-2 group-data-[spacing=0]/toggle-group:shadow-none focus:z-10 focus-visible:z-10 group-data-[spacing=0]/toggle-group:has-data-[icon=inline-end]:pr-1.5 group-data-[spacing=0]/toggle-group:has-data-[icon=inline-start]:pl-1.5 first:group-data-horizontal/toggle-group:data-[spacing=0]:rounded-l-2xl first:group-data-vertical/toggle-group:data-[spacing=0]:rounded-t-2xl last:group-data-horizontal/toggle-group:data-[spacing=0]:rounded-r-2xl last:group-data-vertical/toggle-group:data-[spacing=0]:rounded-b-2xl group-data-horizontal/toggle-group:data-[spacing=0]:data-[variant=outline]:border-l-0 group-data-vertical/toggle-group:data-[spacing=0]:data-[variant=outline]:border-t-0 first:group-data-horizontal/toggle-group:data-[spacing=0]:data-[variant=outline]:border-l first:group-data-vertical/toggle-group:data-[spacing=0]:data-[variant=outline]:border-t`,
        toggleVariants({
