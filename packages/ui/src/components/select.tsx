    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        `
          ...
          border-border bg-transparent px-3 text-sm whitespace-nowrap
          ...
          data-[size=sm]:h-8
          data-[size=xs]:h-6 data-[size=xs]:gap-1 data-[size=xs]:rounded-sm
          data-[size=xs]:px-2 data-[size=xs]:text-xs
