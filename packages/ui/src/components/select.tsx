...
export const selectTriggerVariants = cva(
  `
    ...
    gap-2 rounded-xl border border-input bg-background
    px-[calc(--spacing(3)-1px)] text-left text-base text-foreground
    ring-ring/24 outline-none select-none
    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        ...
        >
          ...
          <div className="
            relative h-full min-w-(--anchor-width) rounded-xl border bg-popover
            shadow-lg/5
            not-dark:bg-clip-padding
          "
          >
    ...
    <SelectPrimitive.Item
      className={cn(
        `
          ...
          rounded-lg py-1 ps-2 pe-4 text-base outline-none
