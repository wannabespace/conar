  ...
  return (
    ...
    >
      ...
      <ComboboxPrimitive.Input
        ...
        render={<Input className="has-disabled:opacity-100" nativeInput size={size} />}
        {...props}
      />
      {showTrigger && (
        <ComboboxTrigger
