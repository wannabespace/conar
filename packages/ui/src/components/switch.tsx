...
const Switch = ({
  ...
  <SwitchPrimitive.Root
    ...
    data-size={size}
    className={cn(
      `peer group/switch focus-visible:focus-ring aria-invalid:border-destructive/60 aria-invalid:ring-destructive/30 data-checked:border-primary data-checked:bg-primary data-unchecked:bg-muted relative inline-flex shrink-0 items-center rounded-2xl border-2 transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 aria-invalid:ring-3 data-disabled:cursor-not-allowed data-disabled:opacity-50 data-unchecked:border-transparent data-[size=default]:h-5 data-[size=default]:w-8 data-[size=sm]:h-4 data-[size=sm]:w-6`,
      className
    )}
    {...props}
  >
