...
const ContextMenuSubTrigger = ({
  ...
  <ContextMenuPrimitive.SubmenuTrigger
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground data-open:bg-accent data-open:text-accent-foreground *:[svg]:text-foreground/70 focus:*:[svg]:text-accent-foreground data-open:*:[svg]:text-accent-foreground flex min-h-7 cursor-default items-center rounded-lg px-2 py-1 text-sm font-[450] tracking-wide outline-hidden select-none data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  >
