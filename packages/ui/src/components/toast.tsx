            ...
            <Toast.Root
              className={cn(
                `
                  ...
                  h-(--toast-calc-height) w-full rounded-lg border
                  bg-[color-mix(in_srgb,var(--popover),var(--color-black)_calc(1%*max(0,var(--toast-index,0))))]
                  text-popover-foreground shadow-lg/5 select-none
          ...
          return (
            ...
            >
              <Toast.Root
                className={cn(
                  `
                    relative border bg-popover text-xs text-balance
                    text-popover-foreground transition-[scale,opacity]
                    not-dark:bg-clip-padding
                    before:pointer-events-none before:absolute before:inset-0
                    before:shadow-[0_1px_--theme(--color-black/4%)]
                ...
                {tooltipStyle
                  ...
                  : (
                      <Toast.Content className="
                        ...
                        gap-1.5 overflow-hidden px-3.5 py-3 text-sm
                      "
                      >
                        <div className="flex gap-2">
                          {Icon && (
