...
const DropdownMenuItem = ({
  ...
  <MenuPrimitive.Item
    ...
    className={cn(
      `group/dropdown-menu-item text-popover-foreground focus:bg-accent focus:text-accent-foreground focus:not-data-[variant=destructive]:**:text-accent-foreground data-[variant=destructive]:text-destructive focus:data-[variant=destructive]:bg-destructive/15 focus:data-[variant=destructive]:text-destructive *:[svg]:text-foreground/70 data-[variant=destructive]:*:[svg]:text-destructive relative flex min-h-7 cursor-default items-center gap-2 rounded-lg px-2 py-1 text-sm font-[450] tracking-wide outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  />
...
const DropdownMenuSubTrigger = ({
  ...
  <MenuPrimitive.SubmenuTrigger
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground focus:not-data-[variant=destructive]:**:text-accent-foreground data-popup-open:bg-accent data-popup-open:text-accent-foreground data-open:bg-accent data-open:text-accent-foreground *:[svg]:text-foreground/70 flex min-h-7 cursor-default items-center gap-2 rounded-lg px-2 py-1 text-sm font-[450] tracking-wide outline-hidden select-none data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  >
...
const DropdownMenuCheckboxItem = ({
  ...
  <MenuPrimitive.CheckboxItem
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground *:[svg]:text-foreground/70 relative flex min-h-7 cursor-default items-center gap-2 rounded-lg py-1 pr-8 pl-2 text-sm font-[450] tracking-wide outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    checked={checked}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  <span
    ...
    className={cn(
      `text-muted-foreground group-focus/dropdown-menu-item:text-accent-foreground ml-auto inline-flex items-center text-xs tracking-widest`,
      className
    )}
    {...props}
  />
