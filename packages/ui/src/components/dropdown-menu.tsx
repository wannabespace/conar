...
const DropdownMenuItem = ({
  ...
  <MenuPrimitive.Item
    ...
    className={cn(
      `group/dropdown-menu-item text-popover-foreground focus:bg-accent focus:text-accent-foreground focus:not-data-[variant=destructive]:**:text-accent-foreground data-[variant=destructive]:text-destructive focus:data-[variant=destructive]:bg-destructive/15 focus:data-[variant=destructive]:text-destructive *:[svg]:text-muted-foreground/60 data-[variant=destructive]:*:[svg]:text-destructive relative flex min-h-7 cursor-default items-center gap-2 rounded-lg px-2 py-1 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  />
...
const DropdownMenuSubTrigger = ({
  ...
  <MenuPrimitive.SubmenuTrigger
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground focus:not-data-[variant=destructive]:**:text-accent-foreground data-popup-open:bg-accent data-popup-open:text-accent-foreground data-open:bg-accent data-open:text-accent-foreground *:[svg]:text-muted-foreground/60 flex min-h-7 cursor-default items-center gap-2 rounded-lg px-2 py-1 text-sm outline-hidden select-none data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    {...props}
  >
...
const DropdownMenuSubContent = ({
  ...
  <DropdownMenuContent
    ...
    className={cn(
      `bg-popover text-popover-foreground ring-foreground/4 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 w-auto min-w-24 rounded-xl p-1 shadow-lg ring-1 ease-[cubic-bezier(0.32,0.72,0,1)] data-closed:duration-100 data-open:duration-150`,
      className
    )}
    align={align}
    alignOffset={alignOffset}
...
const DropdownMenuCheckboxItem = ({
  ...
  <MenuPrimitive.CheckboxItem
    ...
    data-inset={inset}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground *:[svg]:text-muted-foreground/60 relative flex min-h-7 cursor-default items-center gap-2 rounded-lg py-1 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
      className
    )}
    checked={checked}
    {...props}
