...
<Steps>
  ...
  <Step title="Review drafts">Click **Review changes** to see every staged edit — table, column, old value, new value.</Step>
...
<Note>Seeding is a subscription feature. Free accounts get a limited number of runs. See [Plans](/account/plans).</Note>
