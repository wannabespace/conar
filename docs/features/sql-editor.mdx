...
Click the **+** at the end of the tab strip. Each click opens a new runner tab, so you can keep several scratchpads open side by side against the same connection. Every runner keeps its own query text, results, layout, and AI chat.
