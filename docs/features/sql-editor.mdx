...
<CardGroup cols={2}>
  <Card
    title="Generate / modify SQL"
    icon="wand-magic-sparkles"
    href="/features/ai-assistant"
  >
    Press <kbd>Ctrl</kbd>/<kbd>⌘</kbd>+<kbd>K</kbd> in a zone and describe what
    you want. A diff shows the change before you apply it. Subscription feature.
  </Card>
  <Card
    title="Fix on error"
    ...
    href="/features/ai-assistant"
  >
    **Fix with AI** appears next to an error and suggests a correction you apply
    in one click. Subscription feature.
  </Card>
</CardGroup>
