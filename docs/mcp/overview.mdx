...
<Note>
  The MCP integration is in active development and not yet generally available. This page will be expanded with setup steps, available tools, and examples as
