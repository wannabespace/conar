...
<Note>
  MySQL `SET` columns show as **Enums** in the Definitions view. Display only —
  your data and schema are unaffected.
</Note>

<Tip>
  **Test connection** before saving. If it fails, check host, port, credentials,
  and SSL parameters.
</Tip>
