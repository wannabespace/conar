...
<Note>
  Query traffic goes directly between your machine and your database. Tamery's cloud stores only encrypted connection metadata — it never handles live query
  data.
</Note>
