...
<Steps>
  ...
  <Step title="Try the AI assistant">
    Open the AI assistant panel and ask in plain English — e.g. *"top 5 customers by total order value"*. The assistant knows your schema, and can generate, explain, and fix SQL — it opens the table or fills a query tab for you.
  </Step>
</Steps>
