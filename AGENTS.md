...
- **Rules are source of truth; keep accurate.** Claim no longer matching code → fix in same task. Never duplicate a rule across files; never inline rule content into this index — cross-reference.
