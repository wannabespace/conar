...
| One operation | the section's own rule | MySQL renames a constraint through `recreate`; only Postgres/SQL Server toggle a trigger; `enumEditable` splits column-bound enums from type enums |
